...
After your module has been published, please send a request to Terraform on Azure distribution list to ensure we add an "Azure Verified" check box next to the module you've created.
